...
@interface M1ViewController ()
{
    ...
    Indicator *indicator;
    NSArray *listArray;
    M1TableViewCell *cell;
}

@end

@implementation M1ViewController
@synthesize scroll_View,Id,m1_tableView,Category_id;
...
- (void)viewDidLoad {
    ...
    m1_tableView.tableFooterView=[[UIView alloc] initWithFrame:CGRectZero];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat heightr = cell.m1_lbl.frame.origin.y + cell.m1_lbl.frame.size.height+10;
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell=[tableView dequeueReusableCellWithIdentifier:@"m1Q1Cell" forIndexPath:indexPath];
    
    m1_tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    
    cell.m1_lbl.text = [[[listArray objectAtIndex:indexPath.row] valueForKey:@"Point"]valueForKey:@"name"];
    
    CGRect frame = cell.m1_lbl.frame;
    
    frame.size.width = self.view.frame.size.width-50;
    
    cell.m1_lbl.frame = frame;
    
    cell.m1_lbl.numberOfLines = 0;
    
    cell.m1_lbl.lineBreakMode = NSLineBreakByWordWrapping;
    
    [cell.m1_lbl sizeToFit];
    
    frame= cell.m1_img.frame;
    
    frame.origin.y = cell.m1_lbl.frame.origin.y+3;
    
    cell.m1_img.frame = frame;
