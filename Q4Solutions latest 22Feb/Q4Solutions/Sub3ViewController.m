...
-(void)workingWithQ1List{
    ...
    [listConn startConnectionWithString:@"further_steps" HttpMethodType:Post_Type HttpBodyType:paramUrl Output:^(NSDictionary *receivedData){
        ...
        if ([listConn responseCode]==1) {
            ...
            UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"Sub Category3" message:msg delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
   ...
   cell=[tableView dequeueReusableCellWithIdentifier:@"sub3Cell" forIndexPath:indexPath];
